-- `task-execution-and-scheduling` topic's fixed quiz shell (TR+EN) -- SORU İÇERMİYOR, aynı desen
-- spring-mvc-testing/V712, transaction-management/V676 ve önceki tüm konu
...
-- Quiz'e OTOMATİK EKLEMEZ -- `task-execution-and-scheduling` için hiç bir quiz satırı yoktu, bu
...
SELECT id, 'tr', 'default', 'Bilgini Test Et', 0.80, true FROM topic WHERE slug = 'task-execution-and-scheduling';

INSERT INTO quiz (topic_id, language, slug, title, pass_threshold, active)
SELECT id, 'en', 'default', 'Test Your Knowledge', 0.80, true FROM topic WHERE slug = 'task-execution-and-scheduling';
